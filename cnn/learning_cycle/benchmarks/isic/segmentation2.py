...
def segmentation(im):
    ...
    img = cv2.imdecode(np.fromfile(im, dtype=np.uint8),
...
segmentation('C:/Users/usuário/Documents/mestrado/dissertação/datasets/ISIC2017/train/ISIC-2017_Training_Data/ISIC_0000004.JPG')