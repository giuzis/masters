...
do
    python isic.py with _model_name=efficientnet_b6 _optimizer="$val2" _batch_size=4 _lr_init=0.001
done

for val2 in ${optArray[@]}
do
    python isic.py with _model_name=efficientnet_b6 _optimizer="$val2" _batch_size=4 _lr_init=0.0001
done
